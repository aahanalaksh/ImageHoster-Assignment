...
public class ImageController {
    ...
    //By fetching image using Id will enusre the bug related to image details retrieval with same name/title is resolved
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session) {
        ...
        Integer userId = imageUser.getId();
        User user = (User) session.getAttribute("loggeduser");
    ...
    //Ensures even in case of PUT method only the owner can edit the image
    ...
    public String editImageSubmit(@RequestParam("file") MultipartFile file, @RequestParam("imageId") Integer imageId,@RequestParam("tags") String tags, Image updatedImage, HttpSession session, Model model) throws IOException {
        ...
        if (userId.equals(requestUserId)) {
            ...
            model.addAttribute("imageFile", image.getImageFile());
            return "images/image";
        }
